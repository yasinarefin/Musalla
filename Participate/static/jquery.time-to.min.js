 ...
 (function (factory) {
    ...
    $.fn.timeTo = function () {
      ...
      if (
        ...
        options.displayDays =
          options.displayDays > 0 ? Math.floor(options.displayDays) : 3;
      }
      return this.each(function () {
        ...
        if (!data.vals) {
          ...
          data.width =
            Math.round(data.fontSize * 0.8 + data.height * 0.13) || data.width;
          ...
          captionSize =
            data.captionSize ||
            (data.fontSize && Math.round(data.fontSize * 0.43));
    ...
    function tick(digit) {
      ...
      n += step;
      if (
        typeof data.step === "function" &&
        data.tickCount % data.stepCount === 0
      ) {
